...
//****************   COMON FUNCTION FOR SENDING SMS   *********************************//
    function send_sms($message = '', $recieverPhoneNumber= ''){
...
//****************  SEND SMS WITH CLICKATELL SMS API   *********************************//
    function send_sms_via_clickatell($message = '', $recieverPhoneNumber = ''){
...
function send_sms_via_msg91($message = '' , $recieverPhoneNumber = '') {

    $authKey       = $this->db->get_where('sms_settings', array('type' => 'msg91_authentication_key'))->row()->description;
    $senderId      = $this->db->get_where('sms_settings', array('type' => 'msg91_sender_id'))->row()->description;
    $country_code  = $this->db->get_where('sms_settings', array('type' => 'msg91_country_code'))->row()->description;
    $route         = $this->db->get_where('sms_settings', array('type' => 'msg91_route'))->row()->description;

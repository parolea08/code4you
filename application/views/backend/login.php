...
<html lang="en">
	<head>
		...
		<meta name="author" content="CODE4YOY ">
		...
		<!-- color CSS -->
		<link href="<?php echo base_url(); ?>code4you/css/colors/megna.css" id="theme"  rel="stylesheet">
			...
			<script type="text/javascript">
				$(document).ready(function() {
					$.toast({
						...
						heading: 'Error Message', //mm
						text: '<?php echo $this->session->flashdata('error_message'); ?>',
						position: 'top-right',
						loaderBg: '#e28103',
						icon: 'warning',
						hideAfter: 3500, //how long
						stack: 6
					})
				});
			</script>

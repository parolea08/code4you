<div class="row">
                    <div class="col-sm-5">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> &nbsp;&nbsp;<?php echo get_phrase('add_syllabus');?></div>
...
<!----CREATION FORM STARTS---->
                 ...
                 <div class="form-group">
                    ...
                    <div class="form-group">
                    <button type="submit" class="btn btn-info btn-block btn-rounded btn-sm">&nbsp;<?php echo get_phrase('add_syllabus');?></button>
					</div>
			...
			<!----CREATION FORM ENDS-->
                    ...
                    <div class="tabs-vertical-env">
                        ...
                        <li class="<?php if($classess['class_id']== $class_id) echo 'active';?>">
                            ...
                            <a class="btn btn-info btn-rounded btn-sm" href="<?php echo base_url();?>admin/get_academic_syllabus/<?php echo $classess['class_id'];?>" style="color:white">
                    ...
                    <a href="<?php echo base_url();?>admin/download_academic_syllabus/<?php echo $syllabus['academic_syllabus_code'];?>"><button type="button" class="btn btn-success btn-circle btn-xs"><i class="fa fa-download"></i></button></a>
					 ...
					 <a href="<?php echo base_url().'uploads/syllabus/'.  $syllabus['file_name'];?>" target="_blank"><button type="button" class="btn btn-warning btn-circle btn-xs"><i class="fa fa-download"></i></button></a>

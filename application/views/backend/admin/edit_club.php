...
<div class="row">
	<div class="col-sm-12">
		<div class="panel panel-info">
			<div class="panel-heading"> &nbsp;&nbsp;<?php echo get_phrase('edit_club'); ?></div>
			...
			<div class="panel-body table-responsive">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-12">
                        ...
                        <textarea rows="3" class="form-control" name="description"><?php echo $club ['description'];?></textarea>
					</div>
				</div>
				...
				<div class="form-group">
					<button type="submit" class="btn btn-block btn-info btn-rounded btn-sm ">&nbsp;<?php echo get_phrase('save');?></button>
				</div>
                <?php echo form_close();?>
			</div>                
		</div>

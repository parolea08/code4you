<div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-info">
							...
							<?php echo get_phrase('EXAM QUESTION PAPER');?>
						   
						   
                            <div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i><?php echo get_phrase('ADD NEW QUESTION PAPER');?><i class="btn btn-info btn-xs"></i></a> <a href="#" data-perform="panel-dismiss"></a> </div>
                            </div>
               ...
               <div class="form-group">
                    ...
                    <div class="col-sm-12">
					   ...
					   <select name="status" class="form-control select2" style="width:100%;" required>
										<option value=""><?php echo get_phrase('status');?></option>
                                            ...
                                            <option value="0"><?php echo get_phrase('Pending');?></option>
                                    		<option value="1"><?php echo get_phrase('Approve');?></option>
                                            <option value="2"><?php echo get_phrase('Disaprove');?></option>
				...
				<div class="form-group">
                    ...
                    <div class="form-group">
							<button type="submit" class="btn btn-info btn-block btn-sm btn-rounded"> &nbsp;<?php echo get_phrase('add_exam_question');?></button>
					</div>
					<br>
                <?php echo form_close();?>	
...
<table id="example23" class="display nowrap" cellspacing="0" width="100%">
    ...
    <?php $counter = 1; $exam_questions = $this->db->get('exam_question')->result_array();
            ...
            <tr>
                ...
                <img src="<?php echo base_url();?>code4you/images/image.png" style="max-height:40px;">
                <?php }?>
                <?php if($exam_question['file_type']=='docx'){?>
                <img src="<?php echo base_url();?>code4you/images/doc.jpg" style="max-height:40px;">
                <?php }?>
                <?php if($exam_question['file_type']=='pdf'){?>
                <img src="<?php echo base_url();?>code4you/images/pdf.jpg" style="max-height:40px;">
                <?php }?>
                <?php if($exam_question['file_type']=='xlsx'){?>
                <img src="<?php echo base_url();?>code4you/images/text.png" style="max-height:40px;">
                <?php }?>
                ...
                <?php echo get_phrase('Disapproved');?>
                <?php endif;?>
                ...
                <td>
                <a href="<?php echo base_url().'uploads/exam_question/'. $exam_question['file_name'];?>" target="_blank"><button type="button" class="btn btn-info btn-circle btn-xs" ><i class="fa fa-download"></i></button></a>

				...
				<div class="panel-body table-responsive">
				  	...
				  	<div class="row panel-body">
						...
						<div class="col-sm-6">
							...
							<div class="form-group">
								<label class="col-md-9" for="example-text"><?php echo get_phrase('country');?></label>
								<div class="col-sm-12">
									<input type="text" class="form-control" value="<?php echo $student['country'];?>" name="country" value="" >
								</div> 
							</div>
					...
					<div class="form-group">
						...
						<button type="submit" class="btn btn-success btn-sm btn-rounded btn-block">&nbsp;<?php echo get_phrase('edit_student');?></button>

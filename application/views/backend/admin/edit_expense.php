...
<div class="row">
	<div class="col-sm-12">
		<div class="panel panel-info">
			<div class="panel-heading"> <i class="fa fa-list"></i>&nbsp;&nbsp;<?php echo get_phrase('edit_expenses');?></div>
			<div class="panel-wrapper collapse in" aria-expanded="true">
				<div class="panel-body table-responsive">
					...
					<div class="form-group">
						...
						<div class="col-sm-12">
							<input type="date" class="datepicker form-control" name="timestamp" value="<?php echo  $row['timestamp']; ?>"/>
						</div>
					</div>
					
					<div class="form-group">
						<button type="submit" class="btn btn-info btn-rounded btn-block btn-sm"><i class="fa fa-pencil"></i>&nbsp;<?php echo get_phrase('edit_expenses');?></button>
					</div>
					<?php echo form_close();?>
				</div>
			</div>

        ...
        <div class="panel panel-info">
           	<div class="panel-heading">
					 <?php echo get_phrase('Manage Language'); ?>
						...
						<button type="button" class="btn btn-info btn-xs">&nbsp;<?php echo get_phrase('add_language');?>
						</button></a>
						
						<a href="javascript:;" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/add_phrase/');">
						<button type="button" class="btn btn-info btn-xs">&nbsp;<?php echo get_phrase('add_string');?>
						</button></a>
			</div>

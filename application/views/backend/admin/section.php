<div class="row">
                    <div class="col-sm-5">
				  	<div class="panel panel-info">
                            <div class="panel-heading">&nbsp;&nbsp;<?php echo get_phrase('add_section');?></div>
...
<!----CREATION FORM STARTS---->
			...
			<!----CREATION FORM ENDS-->
                    ...
                    <div class="col-sm-7">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> &nbsp;&nbsp;<?php echo get_phrase('list_section');?></div>
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body table-responsive">
                    ...
                    <div class="tabs-vertical-env">
                        ...
                        <li class="<?php if($classess['class_id']== $class_id) echo 'active';?>">
                            ...
                            <a class="btn btn-info btn-rounded btn-sm" href="<?php echo base_url();?>admin/sections/<?php echo $classess['class_id'];?>">
                    ...
                    <?php $counter = 1; $sections =  $this->db->get_where('section', array('class_id' => $class_id))->result_array(); //where class_is is equals to class_id

...
<button onClick="PrintElem('#invoice_print')" class="btn btn-rounded btn-success btn-sm"><i class="fa fa-print"></i>&nbsp;<?php echo get_phrase('print'); ?></button>
<hr>
<div id="invoice_print">
	<table width="100%" border="0">
		<tr>
			<td align="left" valign="top">
				...
				<strong><?php echo get_phrase('PAYMENT TO'); ?></strong><br> <?php echo $this->db->get_where('settings', array('type' => 'system_name'))->row()->description; ?><br>
	...
	<table width="100%" border="0">    
		<tr>
			...
			<td align="right" valign="top">
				<?php echo get_phrase("student_name"); ?> : <?php echo $this->db->get_where('student', array('student_id' => $row['student_id']))->row()->name; ?><br><?php 
					$class_id = $this->db->get_where('student' , array('student_id' => $row['student_id']))->row()->class_id;
					echo get_phrase("student_class").': ' . ' ' . $this->db->get_where('class', array('class_id' => $class_id))->row()->name;
				?><br>
	...
	<table class="table table-bordered" width="100%" border="1" style="border-collapse:collapse;">
        ...
        <table width="100%" border="0">    
			...
			mywindow.document.write('<html><head><title><?php echo get_phrase('Invoice'); ?></title>');

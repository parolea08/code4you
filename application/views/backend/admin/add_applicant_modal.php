<div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> &nbsp;&nbsp;<?php echo get_phrase('add_application'); ?></div>
                ...
                <div class="col-sm-12">
                    ...
                    <div class="form-group">
                        <button type="submit" class="btn btn-info btn-block btn-rounded btn-sm">&nbsp; <?php echo get_phrase('add_applicaton'); ?></button>
                </div>

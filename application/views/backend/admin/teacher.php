	...
	<div class="col-sm-12">
		<div class="panel panel-info">
			<div class="panel-heading"><?php echo get_phrase('new_teacher');?>
				<div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('ADD NEW TEACHER HERE');?><i class="btn btn-info btn-xs"></i></a> <a href="#" data-perform="panel-dismiss"></a> </div>
			</div>
			<div class="panel-wrapper collapse out" aria-expanded="true">
				<div class="panel-body">
					...
					<div class="row">
						<div class="col-sm-6">
							...
							<div class="form-group">
								...
								<div class="col-sm-12">
									<input class="form-control m-r-10" name="birthday" type="date" value="" id="example-date-input" required>
								</div> 
							</div>
						...
						<div class="col-sm-6">
							...
							<hr>
							<div class="alert alert-primary"><?php echo get_phrase('HUMAN RESOURCES INFORMATION');?></div>
							<hr>			 
							...
							<div class="form-group">
								...
								<div class="col-sm-12">
									<input type="date" class="form-control datepicker" name="date_of_joining" value="" required>
								</div> 
							</div>
							<div class="form-group">
							...
							<hr>
							<div class="alert alert-primary"><?php echo get_phrase('BANK ACCOUNT DETAILS'); ?></div>
							<hr>
					...
					<div class="form-group">			
						<button type="submit" class="btn btn-primary btn-rounded btn-block btn-sm"> &nbsp;<?php echo get_phrase('add_teacher');?></button>
							...
							<?php foreach($select_teacher as $key => $teacher){ ?>
								<tr>
									...
									<td>
										...
										<a href="<?php echo base_url().'uploads/teacher_image/'.  $teacher['file_name'];?>" target="_blank"><button type="button" class="btn btn-warning btn-circle btn-xs"><i class="fa fa-download"></i></button></a>

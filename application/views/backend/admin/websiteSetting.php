					...
					<div class="sttabs tabs-style-linetriangle">
						<nav>
							<ul>
								...
								<li><a href="#section-linetriangle-4"><span><?php echo get_phrase('Subscribers');?></span></a></li>
						...
						<div class="content-wrap">
							<section id="section-linetriangle-1">
								...
								<div class="form-group">
									<label class="col-md-12" for="example-text"><?php echo get_phrase('Facebook Link Code');?></label>
									<div class="col-sm-12">
										<textarea class="form-control" name="facebook_link_code"><?php echo $this->db->get_where('website_settings', array('type' => 'facebook_link_code'))->row()->description;?></textarea>
										<p style="color:green"> Please make sure your link looks like this: https://www.facebook.com/code4you WHERE code4you is your facebook group name</P>
									</div>
								</div>
							...
							<section id="section-linetriangle-2">
								...
								<table id="example" class="display nowrap" cellspacing="0" width="100%">
									...
									<tbody>
										...
										<tr>
											<td><img src="<?php echo base_url();?>uploads/banner_image/<?php echo $banner['banner_image'];?>"  width="80px" height="50px"></td>
							...
							<section id="section-linetriangle-5">
								...
								<table id="example23" class="display nowrap" cellspacing="0" width="100%">
									<thead>
										<tr>
											<th><div><?php echo get_phrase('Visitor Name');?>

<div class="row">
                    <div class="col-sm-5">
				  	<div class="panel panel-info">
                            <div class="panel-heading">&nbsp;&nbsp;<?php echo get_phrase('add_vacancy'); ?></div>
...
<?php echo form_open(site_url('admin/vacancy/insert'), array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
                ...
                <div class="form-group">
                   <label class="col-md-12" for="example-text"><?php echo get_phrase('date_of_application'); ?></label>
                ...
                <div class="form-group">
                        <button type="submit" class="btn btn-block btn-info btn-rounded btn-sm">&nbsp; <?php echo get_phrase('add_vacancy'); ?></button>
                </div>
                <?php echo form_close(); ?>
		 		</div>                
			</div>
...
<div class="panel-wrapper collapse in" aria-expanded="true">
    ...
    <thead>
        <tr>
            ...
            <th><div><?php echo get_phrase('date_of_application'); ?></div></th>

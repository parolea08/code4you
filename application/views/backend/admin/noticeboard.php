<div class="row">
                    <div class="col-sm-5">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> &nbsp;&nbsp;<?php echo get_phrase('add_noticeboard'); ?></div>
...
<!----CREATION FORM STARTS---->
	...
	<div class="form-group">
            <label class="col-md-12" for="example-text"><?php echo get_phrase('Event_title');?></label>
        <div class="col-sm-12">
    ...
    <div class="form-group">
            <button type="submit" class="btn btn-info btn-sm btn-block btn-rounded"> &nbsp;&nbsp;<?php echo get_phrase('send_noticeboard');?></button>
    </div>
    <?php echo form_close();?>            

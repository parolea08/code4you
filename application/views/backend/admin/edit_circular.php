...
<div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading">&nbsp;&nbsp;<?php echo get_phrase('edit_circular'); ?></div>
...
<!----CREATION FORM STARTS---->
	...
	<div class="form-group">
		...
		<input class="form-control m-r-10" name="date" type="date" value="<?php echo $circular ['date'];?>" id="example-date-input" required>
                           ...
                           <div class="form-group">
                                  <button type="submit" class="btn btn-info btn-sm btn-block btn-rounded"> &nbsp;&nbsp;<?php echo get_phrase('save');?></button>
                            </div>
                    <?php echo form_close();?>            

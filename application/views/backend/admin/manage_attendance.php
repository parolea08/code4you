...
<div class="row">
	<div class="col-sm-12">
		<div class="panel panel-info">
			<div class="panel-heading"> &nbsp;&nbsp;<?php echo get_phrase('Attendance');?></div>
			<div class="panel-body table-responsive">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-12">
						<input type="date" class="form-control datepicker" id="example-date-input" name="timestamp" date-format="dd-mm-yyyy" value="<?php echo $date."-".$month."-".$year ;?>" required>
					</div>
				</div>
	  	...
	  	<div class="panel panel-info">
            <div class="panel-body table-responsive">
				...
				<?php $classes = $this->db->get('class')->result_array();
                    ...
                    <h3 style="color:#696969;"><?php echo get_phrase('Attendance For');?>: <?php echo $class_name;?></h3>
							...
							<?php $students = $this->db->get_where('student', array('class_id' => $class_id))->result_array();
								...
								<tr class="gradeA">
									...
									<td>
										...
										<?php 
											//inserting blanck page for students attendance if not available
											//we dont have student_id in attendance table
											...
											//showing the attendance of student, if exist
											$attendance = $this->db->get_where('attendance', $verify_data)->row();
											$status = $attendance->status;
										?>
										<select name="status_<?php echo $student['student_id'];?>" class=" form-control">
											
											<option value="1"<?php if($status == 1) echo 'selected="selected"';?>><?php echo get_phrase('Present');?></option>
											<option value="2"<?php if($status == 2) echo 'selected="selected"';?>><?php echo get_phrase('Absent');?></option>
											<option value="3"<?php if($status == 3) echo 'selected="selected"';?>><?php echo get_phrase('Late');?></option>

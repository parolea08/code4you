<div class="row">
                    <div class="col-sm-12">
                        <div class="panel panel-info">
							...
							<?php echo get_phrase('STUDY MATERIAL');?> 
						   
						   
                                <div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i><?php echo get_phrase('ADD NEW MATERIAL HERE');?><i class="btn btn-info btn-xs"></i></a> <a href="#" data-perform="panel-dismiss"></a> </div>
                            </div>
               ...
               <div class="form-group">
				...
				<div class="form-group">
                    ...
                    <div class="form-group">
							<button type="submit" class="btn btn-info btn-block btn-sm btn-rounded"> &nbsp;<?php echo get_phrase('add_material');?></button>
					</div>
					<br>
                <?php echo form_close();?>	
...
<table id="example23" class="display nowrap" cellspacing="0" width="100%">
    ...
    <?php $counter = 1; $material = $this->db->get('material')->result_array();
            ...
            <tr>
                ...
                <td>
                <a href="<?php echo base_url().'uploads/study_material/'. $material['file_name'];?>" target="_blank"><button type="button" class="btn btn-info btn-circle btn-xs" ><i class="fa fa-download"></i></button></a>

...
<div class="row">
	<div class="col-sm-12">
		<div class="panel panel-info">
			<div class="panel-heading">&nbsp;&nbsp;<?php echo get_phrase('expense_category'); ?></div>
			...
			<div class="panel-body table-responsive">
				...
				<div class="form-group">
					<button type="submit" class="btn btn-block btn-info btn-rounded btn-sm ">&nbsp;<?php echo get_phrase('update_category');?></button>
				</div>
                <?php echo form_close();?>
			</div>                
		</div>

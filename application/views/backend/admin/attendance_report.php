...
<?php $active_sms_gateway = $this->db->get_where('sms_settings' , array('type' => 'active_sms_gateway'))->row()->info; ?>
 ...
 <div class="row">
        ...
        <div align="center">
        KEYS: 
        <?php echo get_phrase('Present');?>&nbsp;-&nbsp; <i class="fa fa-circle" style="color: green;"></i>&nbsp;&nbsp;
       <?php echo get_phrase('Absent');?> &nbsp;-&nbsp;<i class="fa fa-circle" style="color: red;"></i>&nbsp;&nbsp;
        
        <?php echo get_phrase('Late');?>&nbsp;-&nbsp; <i class="fa fa-circle" style="color: #FF6600;"></i>&nbsp;&nbsp;
 ...
 <div class="form-group">
			...
			<div class="form-group">
                ...
                <div class="col-sm-12">
                    ...
                    <?php $list_year = array( "2020", "2021","2022", "2023","2024", "2025", "2026");
			...
			<div class="form-group">
			<button type="button" class="btn btn-info btn-rounded btn-block btn-sm" id="find"><i class="fa fa-search"></i>&nbsp;<?php echo get_phrase('get attendance');?></button>
		 </div>

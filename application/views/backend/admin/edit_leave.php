...
<div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading">&nbsp;&nbsp;<?php echo get_phrase('edit_leave'); ?></div>
                    ...
                    <div class="form-group">
                       <label class="col-md-12" for="example-text"><?php echo get_phrase('status'); ?></label>
                        ...
                        <div class="col-sm-12">
                           ...
                           <div class="form-group">
                                  <button type="submit" class="btn btn-block btn-info btn-rounded btn-sm ">&nbsp;<?php echo get_phrase('update_leave');?></button>
							</div>
                <?php echo form_close();?>
                </div>                
			</div>

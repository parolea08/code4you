...
<div class="row">
                    <div class="col-sm-12">
				  	<div class="panel panel-info">
                            <div class="panel-heading">&nbsp;&nbsp;<?php echo get_phrase('edit_vacancy'); ?></div>
...
<?php echo form_open(base_url(). 'admin/vacancy/update/' . $vacancy['vacancy_id'], array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
                ...
                <div class="form-group">
                        <button type="submit" class="btn btn-block btn-info btn-rounded btn-sm">&nbsp; <?php echo get_phrase('update_vacancy'); ?></button>
                </div>
                <?php echo form_close(); ?>
		 		</div>                
			</div>

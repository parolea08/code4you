    ...
    <div class="col-sm-12">
		<div class="panel panel-info">
                ...
                <div class="form-group">
					...
					<div class="col-sm-12">
						...
						<select name="active_sms_gateway" class="form-control select2" required>
							<option value="clickatell"<?php if($active == 'clickatell') echo 'selected';?>><?php echo get_phrase('clickatell');?></option>
			...
			<div class="row">
				<div class="col-sm-6">
				  	<div class="panel panel-info">
						<div class="panel-heading"> &nbsp;&nbsp;<?php echo get_phrase('clickatell');?> 
			...
			<div class="col-sm-6">
				<div class="panel panel-info">
					<div class="panel-heading"> &nbsp;&nbsp;<?php echo get_phrase('msg91');?>

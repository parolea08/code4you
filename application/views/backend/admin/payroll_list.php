...
<div class="row">
	<div class="col-sm-12">
		<div class="panel panel-info">
			<div class="panel-heading">&nbsp;&nbsp;<?php echo get_phrase('list_payroll'); ?></div>
				...
				<div class="col-md-5">
					<div class="form-group">
						...
						<select name="year" class="form-control select2">
							<?php $list_year = array("2020", "2021","2022", "2023","2024", "2025");
					...
					<table class="table table-bordered">
						...
						<tbody>
							...
							<tr>
								...
								<td>
									<?php $user =  $this->db->get_where('teacher',array('teacher_id' => $row['user_id']))->row(); //ytable teacher where teacher_id is equal ti user_id from payroll
									echo $user->name;?>
								</td>
								<td>

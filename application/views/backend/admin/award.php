<div class="row">
                    <div class="col-sm-5">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> &nbsp;&nbsp;<?php echo get_phrase('add_award'); ?></div>
...
<?php echo form_open(site_url('admin/award/create'), array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data')); ?>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                                  <button type="submit" class="btn btn-block btn-info btn-sm btn-rounded"> &nbsp;&nbsp;<?php echo get_phrase('add_award');?></button>
							</div>
 <?php echo form_close(); ?>                
 				</div>                
			</div>

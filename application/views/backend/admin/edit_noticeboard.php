...
<div class="row">
    <div class="col-sm-12">
	 	<div class="panel panel-info">
            <div class="panel-heading"> <i class="fa fa-edit"></i>&nbsp;&nbsp;<?php echo get_phrase('edit_event'); ?></div>
	        	<div class="panel-body table-responsive">
                            ...
                            <!----CREATION FORM STARTS---->
                                ...
                                <div class="form-group">
                                        <button type="submit" class="btn btn-info btn-sm btn-block btn-rounded">&nbsp;&nbsp;<?php echo get_phrase('update');?></button>
                                </div>
                                <?php echo form_close();?>            

                    ...
                    <div class="col-sm-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">&nbsp;
                                <div class="pull-right"><a href="#" data-perform="panel-collapse"><i class="fa fa-plus"></i>&nbsp;&nbsp;<?php echo get_phrase('CREATE NEW LIVE CLASS');?></a> <a href="#" data-perform="panel-dismiss"></a> </div>
                            </div>
                            <div class="panel-wrapper collapse out" aria-expanded="true">
                                <div class="panel-body">
								
								
			<?php echo form_open(base_url() . 'admin/live_class/add/' , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					<div class="row">
                    <div class="col-sm-6">
                    ...
                    <tbody>
					 ...
					 <?php $select = $this->live_class_model->selectLiveClassInformationByUser();
                        ...
                        <tr>
							...
							<a href="<?php echo base_url();?>admin/edit_live_class/<?php echo $row['live_class_id'];?>"><button type="button" class="btn btn-info btn-rounded btn-sm"><i class="fa fa-edit"></i> <?php echo get_phrase('edit');?></button></a>
							
						
							<a href="<?php echo base_url();?>admin/host_live_class/<?php echo $row['live_class_id'];?>"><button type="button" class="btn btn-success btn-rounded btn-sm"><i class="fa fa-youtube-play"></i> <?php echo get_phrase('start streaming');?></button></a>
							
							 <a href="#" onclick="confirm_modal('<?php echo base_url();?>admin/live_class/delete/<?php echo $row['live_class_id'];?>');"><button type="button" class="btn btn-danger btn-rounded btn-sm"><i class="fa fa-times"></i> <?php echo get_phrase('delete');?> </button></a>

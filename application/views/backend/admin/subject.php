<div class="row">
                    <div class="col-sm-5">
				  	<div class="panel panel-info">
                            <div class="panel-heading">&nbsp;&nbsp;<?php echo get_phrase('add_subject');?></div>
...
<!----CREATION FORM STARTS---->
			...
			<!----CREATION FORM ENDS-->
                    ...
                    <div class="col-sm-7">
				  	<div class="panel panel-info">
                            <div class="panel-heading"> &nbsp;&nbsp;<?php echo get_phrase('list_subject');?></div>
                            <div class="panel-wrapper collapse in" aria-expanded="true">
                                <div class="panel-body table-responsive">
                 ...
                 <button type="button" id="find" class="btn btn-success btn-rounded btn-sm btn-block"><?php echo get_phrase('Get Subject');?></button>
                 <hr>

    ...
    <body>
       ...
       <?php 
        ...
        <script type="text/javascript">
            ...
            var meetConfig = {
                apiKey: "<?=$this->db->get_where('settings', array('type' => 'zoom_api_key'))->row()->description;?>",
                apiSecret: "<?=$this->db->get_where('settings', array('type' => 'zoom_api_secret_key'))->row()->description;?>",

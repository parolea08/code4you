...
<div class="logo_nav_outer_wrap">
	<div class="container">
		<div class="logo_wrap">
			<a href="#"><img src="<?php echo base_url();?>uploads/logo.png" alt="School Logo" width="60px" height="60px"></a>
		</div>
									...
									<li class="dropdown"> 
										<a href="#" class="dropdown-toggle" data-toggle="dropdown" >
											...
											<?php 
												...
												$list_name =  $this->db->get_where('language_list', array('db_field' => $set_language))->row()->name;
											?>
											<img src="<?php echo base_url();?>code4you/flag/<?php echo $list_image;?>.png" width="16px" height="16px"> <?php echo $list_name;?> <i class="fa fa-caret-down"></i>
										</a>

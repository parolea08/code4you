                	...
                	<div class="col-md-4 col-sm-6">
                    	<div class="get_started_services">
                            ...
                            <div class="get_icon_des">
                                ...
                                <a href="#"><?php echo get_phrase('View More');?> <i class="fa fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4 col-sm-6">
        ...
        <section class="ct_courses_subject_bg">
        	<div class="container">
                ...
                <div class="ct_heading_1_wrap ct_white_hdg">
                    ...
                    <span><img src="<?php echo base_url();?>uploads/hdg-01.png" alt="" class="logo"></span>
                </div>
        ...
        width: 80px !important;
                ...
                foreach ($select_all_testimonies as $key => $all_testimonies_selected_from_table):?>
                	...
                	<div class="item">
						...
						<span><b><?php echo get_phrase('Name');?></b>, <?php echo $this->db->get_where('parent', array('parent_id' => $all_testimonies_selected_from_table['parent_id']))->row()->name;?></span>
                        </div>
                    </div>
                <?php endforeach;?>
        ...
        <section class="ct_facts_bg">
            ...
            <ul>
                ...
                <li>
                    ...
                    <h2 class="counter"  style="color:#e625ea"><?php echo $this->db->get('class')->num_rows();?></h2>
                    <span style="color:#e625ea"><?php echo get_phrase('Our Classes');?></span>
                </li>
                <li>

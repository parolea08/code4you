        	...
        	<div class="container">
            	<div class="row">
                	<div class="col-md-6">
                      ...
                      <a href="#"><?php echo $this->db->get_where('settings', array('type' => 'footer'))->row()->description;?>.  <?php echo date('Y');?></a>
                        </div>
                    </div>
                    <div class="col-md-6">

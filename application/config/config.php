...
|
*/
//if we will make an error it will go to application/logs 
...
|
*/
$config['encryption_key'] = 'code4youSoftware';
...
$config['csrf_token_name'] = 'code4yousoftware';
$config['csrf_cookie_name'] = 'code4yousoftware';
